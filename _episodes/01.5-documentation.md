...
New users should be automatically added to the access list. If you can't access the wiki please send mail to [lrogas@fnal.gov](mailto:lrogas@fnal.gov) specifying the error you see.  We've found that changing your email address can result in access problems. 
...
DUNE has a Github organization: [https://github.com/DUNE/](https://github.com/DUNE/).  Repositories in that organization are generally public to read but you need to request access through [DUNE Github Request](mailto:bv@bnl.gov).

Many repositories have wikis or associated dune.github.io pages and you can search for words throughout.

## The DUNE Computing Conceptual Design Report

The plan for DUNE Computing was written up a [Offline Computing Conceptual Design Report](https://arxiv.org/abs/2210.15665). We ended up doing most of what we said we would so it's useful for understanding the tools we are using.
...
If you can't find it - go to DUNE Slack and either look for an appropriate channel or ask in `#computing-questions`.  Someone will help you find what you need.