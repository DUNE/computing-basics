...
- [Step 3: Mission setup](#step-3-mission-setup)
   ...
   - [ssh-in](#ssh-in)
   - [Check that your kerberos ticket forwarded](#check-that-your-kerberos-ticket-forwarded)
   - [Always use a clean shell](#always-use-a-clean-shell)
...
- [Step 5. Exercises](#step-5.-exercises)
   - [Exercise - SL7 version](#exercise---sl7-version)
   - [Exercise AL9 version](#exercise-al9-version)
